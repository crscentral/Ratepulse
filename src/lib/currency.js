...
// For amounts that are ALREADY in the target currency (e.g. live data fetched
// directly from SerpApi in that currency) — just adds the symbol, no
// INR-based conversion. Using formatCurrency on already-correct-currency
// numbers would double-convert them and produce wrong figures.
