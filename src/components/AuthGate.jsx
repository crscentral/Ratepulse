    ...
    <div className="min-h-screen flex items-center justify-center bg-cream font-body px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <img src={logoFull} alt="CRS RatePulse — By The Chauhans" className="mx-auto max-w-[260px] sm:max-w-[300px] w-full h-auto mb-3" />
          <p className="text-sm text-gray-500">by CRS Central — Revenue Intelligence</p>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 sm:p-7">{children}</div>
      </div>
    </div>
  );
}
